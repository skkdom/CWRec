...
#     weighted_adjacency_matrix_cpu = weighted_adjacency_matrix.cpu()
#     del weighted_adjacency_matrix
#     return weighted_adjacency_matrix_cpu
...
#     del adj, rowsum, d_inv_sqrt, d_mat_inv_sqrt  # 释放内存
...
#     sim_cpu = sim.cpu()
#     del context, context_norm, sim  # 释放内存
#     return sim_cpu
