...
#         user_cold_list = np.load("/mnt/MCDRec/data/ml_1m/user_cold_list_15.npy")
#         user_cold_list = np.load("/mnt/MCDRec/data/allrecipes/user_cold_list_2.npy")
#         user_cold_list = np.load("/mnt/MCDRec/data/cd/user_cold_list_1.npy")
        num_users = len(pos_len_list)
        all_users = list(range(num_users))
#         user_warm_list = list(set(all_users) - set(user_cold_list))    
...
#             ipdb.set_trace()
        ...
        # Calculate metrics for cold users
#         cold_metric_dict = self.get_metrics(pos_len_list, bool_rec_matrix, user_cold_list, '_cold')

#         # Calculate metrics for warm users
#         warm_metric_dict = self.get_metrics(pos_len_list, bool_rec_matrix, user_warm_list, '_warm')

        # Combine all dictionaries
#         metric_dict = {**all_metric_dict, **cold_metric_dict, **warm_metric_dict}        
